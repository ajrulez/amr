...
public class Test7 {
    ...
    static List<Function<Pair<LabeledSequence,Integer>,Object>> seqFeatures =
            new ArrayList<Function<Pair<LabeledSequence,Integer>,Object>>(){{
                ...
                add((pair) -> pair.first.annotation.get(CoreAnnotations.TokensAnnotation.class).get(pair.second).
                        get(CoNLL2011DocumentReader.NamedEntityAnnotation.class));
                add((pair) -> {
                    pair.first.annotation.get(CoreAnnotations.SpanAnnotation.class);
                    return "Blarg";
                });
            }};
