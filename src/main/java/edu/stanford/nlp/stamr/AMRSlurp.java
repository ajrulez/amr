...
import edu.stanford.nlp.stamr.annotation.AnnotationManager;
...
/**
 * Parser to handle reading in edu.stanford.nlp.stamr.AMR sentences
 */
public class AMRSlurp {
    ...
    public static AMR parse(String amr, String header, Format format) throws IOException {
        ...
        // A bunch of boilerplate to read in edu.stanford.nlp.stamr.AMR using ANTLR
