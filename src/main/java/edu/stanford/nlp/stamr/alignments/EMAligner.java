package edu.stanford.nlp.stamr.alignments;

import edu.stanford.nlp.ie.NumberNormalizer;
import edu.stanford.nlp.stamr.AMR;
import edu.stanford.nlp.stamr.AMRConstants;
import edu.stanford.nlp.stamr.alignments.conditional.binary.*;
...
import edu.stanford.nlp.stamr.alignments.conditional.unary.EditDistanceUnaryFeature;
import edu.stanford.nlp.stamr.alignments.conditional.unary.LexicalUnaryFeature;
import edu.stanford.nlp.stamr.alignments.conditional.unary.PossessiveBiasFeature;
import edu.stanford.nlp.stamr.ontonotes.SRL;
import edu.stanford.nlp.stamr.ontonotes.SRLSlurp;
import edu.stanford.nlp.stamr.alignments.Projectifier;
import edu.stanford.nlp.stamr.utils.TimingEstimator;
import edu.stanford.nlp.util.IdentityHashSet;

import java.util.*;

/**
 * Handles aligning edu.stanford.nlp.stamr.AMR to source tokens, using an EM algorithm
 */
